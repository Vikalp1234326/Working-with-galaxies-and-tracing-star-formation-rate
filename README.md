...
5. In the file SFR_trends.ipynb you will the construction of plots that can be used for making radial variation trend plot in SFR, identification of outliers with high value of SFR and construction of contour plots.
